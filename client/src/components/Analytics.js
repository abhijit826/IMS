  ...
  useEffect(() => {
    ...
    const fetchAnalyticsData = async () => {
      ...
      try {
        ...
        const topSellingRes = await fetch(`${apiUrl}/api/analytics/top-selling`, {
        ...
        const turnoverRes = await fetch(`${apiUrl}/api/analytics/turnover`, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        });
        ...
        const lowStockRes = await fetch(`${apiUrl}/api/analytics/low-stock-trends`, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        });
        ...
        const utilizationRes = await fetch(`${apiUrl}/api/analytics/warehouse-utilization`, {
          headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
        });
